...
class AW_Sociable_Block_System_Config_Form_Fieldset_Link extends Mage_Adminhtml_Block_System_Config_Form_Field{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html.= '<td class="value">';
        $html.= '<a href=\''.$element->getValue().'\' title=\''.$element->getLabel().'\'>'.$element->getValue().'</a>';
