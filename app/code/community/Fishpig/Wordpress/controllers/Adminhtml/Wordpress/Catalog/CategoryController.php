...
class Fishpig_Wordpress_Adminhtml_Wordpress_Catalog_CategoryController extends Mage_Adminhtml_Controller_Action
{
	/**
	...
	{
		return Mage::helper('wordpress/database')->connect();
	}
