...
abstract class Fishpig_Wordpress_Model_Mysql4_Abstract extends Mage_Core_Model_Mysql4_Abstract
{
	 ...
	 * @return null|mixed
	 */
	public function getMetaValue(Fishpig_Wordpress_Model_Meta_Abstract $object, $metaKey, $selectField = 'meta_value')
	{
		if ($object->hasMeta()) {
	 ...
	 */
	public function setMetaValue(Fishpig_Wordpress_Model_Meta_Abstract $object, $metaKey, $metaValue)
	{
		if ($object->hasMeta()) {
